...
::: {.pill-row}
<div class="pill fragment"><i class="fa-solid fa-filter"></i> Signal validation before inference</div>
<div class="pill fragment"><i class="fa-solid fa-wave-square"></i> Features grounded in physiology</div>
<div class="pill fragment"><i class="fa-solid fa-shield-halved"></i> Robustness beyond a single p-value</div>
<div class="pill fragment"><i class="fa-solid fa-plug"></i> Pipeline ready for backend use</div>
:::
