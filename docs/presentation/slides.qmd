...
::: {.hero-band}
Can a 40-second VR trial produce pupil signals reliable enough to use as biomarkers? Here is what I found, how I tested it, and how it connects to your product.
:::

::: {.pill-row}
<div class="pill fragment">Signal validation before inference</div>
<div class="pill fragment">Features grounded in physiology</div>
<div class="pill fragment">Robustness beyond a single p-value</div>
<div class="pill fragment">Pipeline ready for backend use</div>
:::

::: notes
- Three threads: signal quality and validation, feature engineering and candidate selection, how the pipeline could sit in a regulated product.
- STAI scores are subjective; that is why robustness checks dominate the methodology rather than ranking on a single statistic.
:::
...
::: {.column width="58%"}
```{=html}
<div class="trial-chain">
  <div class="tc-box"><div class="tc-val">5 s</div><div class="tc-label">Baseline</div></div>
  <div class="tc-arrow">&#8594;</div>
  <div class="tc-box"><div class="tc-val">30 s</div><div class="tc-label">Relaxation</div></div>
  <div class="tc-arrow">&#8594;</div>
  <div class="tc-box"><div class="tc-val">5 s</div><div class="tc-label">Break</div></div>
</div>
```
...
Self-report STAI is the target. Subjective targets demand harder robustness checks than performance labels would.
:::
:::
:::
...
<div class="pipeline">
  ...
  <div class="pipeline-arrow">&#8595;</div>
  <div class="pipeline-step"><span class="step-num">6</span><span class="step-label">Metadata effect-size screen</span><span class="step-detail">&nbsp;— age, sex, calibration, trial order</span></div>
  <div class="pipeline-arrow">&#8595;</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Ingestion</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Storage</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Async processing</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Analysis &amp; scoring</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Serving</div>
...
<div class="flow-step fragment">
  ...
  <div class="fs-body">
    <div class="fs-title">Monitoring</div>
...
<div class="process-strip">
  <div class="process-cell"><div class="pc-num">1</div><div class="pc-title">Develop</div><div class="pc-detail">feature branch<br>MLflow tracking<br>DVC dataset version</div></div>
  <div class="process-cell"><div class="pc-num">2</div><div class="pc-title">Pre-freeze</div><div class="pc-detail">CI: unit + schema tests<br>baseline output diff</div></div>
  <div class="process-cell"><div class="pc-num">3</div><div class="pc-title">Freeze</div><div class="pc-detail">release branch<br>pin deps<br>lock feature defs</div></div>
  <div class="process-cell"><div class="pc-num">4</div><div class="pc-title">Validate</div><div class="pc-detail">locked-dataset rerun<br>sign-off in QMS</div></div>
  <div class="process-cell"><div class="pc-num">5</div><div class="pc-title">Release</div><div class="pc-detail">tagged version<br>artifact bundle hash</div></div>
  <div class="process-cell" style="background:var(--accent-soft);"><div class="pc-num">6</div><div class="pc-title">Post-freeze</div><div class="pc-detail">version bump<br>full re-validation<br>past versions reproducible</div></div>
</div>
```
...
<div class="card-grid">
  ...
  <div class="card fragment">
    <h3>No predictive model yet</h3>
    <p>This work stops at validated candidates. A multivariate model with nested cross-validation is the natural next step.</p>
  </div>
  <div class="card fragment">
    <h3>Habituation unmodelled</h3>
    <p>Trial 1 differs from trial 10 as subjects acclimate. A mixed-effects model with trial index would partition this variance.</p>
  </div>
  <div class="card fragment">
    <h3>Bootstrap CIs</h3>
    <p>Point estimates only; resampled confidence intervals would communicate uncertainty more honestly to non-statisticians.</p>
  </div>
  <div class="card fragment">
    <h3>Cross-cohort validation</h3>
    <p>The frozen z-score params are designed for incremental scoring. They need a held-out cohort to confirm they actually generalise.</p>
  </div>
</div>
```
...
- Habituation modelling is the most concrete methodological next step — mixed-effects with trial index would change the picture for tonic features.
- Cross-cohort validation is the gating item before any clinical or product claim. Until then, the candidates are exploratory.
:::
...
::: {.pill-row}
<div class="pill fragment">Validate first</div>
<div class="pill fragment">Stay interpretable</div>
<div class="pill fragment">Earn the claim</div>
:::
