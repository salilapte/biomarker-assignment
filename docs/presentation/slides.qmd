...
The same six candidates from univariate ranking dominate the STAI-aligned PCs.
:::

::: {.column .fragment width="33%"}
### <i class="fa-solid fa-code-branch"></i> Shared Variance
Loadings spread across PC2 and PC3 — two supporting factors rather than one clean axis.
:::

::: {.column .fragment width="33%"}
### <i class="fa-solid fa-check-double"></i> Corroboration
PCA acts as an independent structural confirmation, not just a discovery tool.
:::
:::
